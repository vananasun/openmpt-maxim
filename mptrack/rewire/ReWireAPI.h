...
extern ReWireError ReWireUnloadReWireSharedLibrary(void);
    ...
    /** Tracktion additonal notes:
        Added accessors for the verison number and folder names used in ReWireFilter to install the ReWire library.
     */
    extern int getRequiredVersionNumMajor();
    extern int getRequiredVersionNumMinor();
    extern const char* getPropellerheadFolderName();
    extern const char* getReWireFolderName();
    extern const char* getReWireLibraryName();
