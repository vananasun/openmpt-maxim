...
#if defined(WINDOWS) || defined(MAC) || defined(WIN32)
...
ReWireError ReWireUnloadReWireSharedLibrary(void) {
    ...
    int getRequiredVersionNumMajor()            { return kReWireCompatibleMajor; }
    int getRequiredVersionNumMinor()            { return kReWireCompatibleMinor; }
    const char* getPropellerheadFolderName()    { return kPropellerheadFolderName; }
    const char* getReWireFolderName()           { return kReWireFolderName; }
    const char* getReWireLibraryName()          { return "ReWire"; }
