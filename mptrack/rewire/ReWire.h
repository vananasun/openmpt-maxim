...
#else
    #ifdef MAC
        ~"Can not determine platform, please set preprocessor define WINDOWS or MAC to 1"
    #endif /* MAC */
#endif /* WINDOWS */
...
#if DEBUG!=0
    #ifdef NDEBUG
        ~"Can not determine debug/release mode, please set preprocessor define DEBUG 1 or 0"
    #endif /* NDEBUG */
#endif /* DEBUG */
#if DEBUG==0
    #ifndef NDEBUG
